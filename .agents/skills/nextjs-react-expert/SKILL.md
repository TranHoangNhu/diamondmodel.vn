...
| `3-server-server-side-performance.md`   | 🟠 **HIGH**        | 8 rules  | Slow SSR, API route optimization, server-side waterfalls        |
...
| `6-rendering-rendering-performance.md`  | 🟡 **MEDIUM**      | 11 rules | Rendering bottlenecks, virtualization, image optimization       |
...
**Total: 62 rules across 8 categories**
...
**Date:** January 2026
**Version:** 1.0.0
**Total Rules:** 62 across 8 categories
